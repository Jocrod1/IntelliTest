...
function CustomDrawerContent(props) {
  ...
  function rednerFilteredItemsDrawer() {
    return (
      <View>
        <TouchableOpacity
  ...
  function renderPublicAPI() {
    return (
      <View>
        <TouchableOpacity
          onPress={props.ToPublicAPI}
          testID="customDrawer-ToPublicAPI">
          <View style={styles.parentItem}>
            <Text style={styles.title}>{'Public API'}</Text>
          </View>
        </TouchableOpacity>
      </View>
    );
  ...
  return (
    <ScrollView style={styles.drawerContainer}>
      <SafeAreaView
        ...
        {mainDrawer ? renderMainDrawer() : rednerFilteredItemsDrawer()}
      </SafeAreaView>
    </ScrollView>
  );
}
